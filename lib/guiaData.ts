...
// Nota: o item sobre "mensalidade" que existia aqui foi removido —
// é a mesma alucinação de pagamento/PIX confirmada como inventada por
// outra IA, que também tinha vazado pro bloco "pagamentos" do SECOES_GUIA.
...
// Bloco "pagamentos" removido — conteúdo confirmado como alucinação
// de outra IA (mensalidade/PIX que não existe de verdade no bolão).
