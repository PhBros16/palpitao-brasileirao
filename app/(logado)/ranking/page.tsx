      ...
      {dados && (
        <>
          ...
          {frenteFrente && (
            <FrenteFrenteModal
              jogadorA={{
                participantId: frenteFrente.a.participantId,
                nome: frenteFrente.a.nome,
                avatar: frenteFrente.a.avatar,
                emoji: frenteFrente.a.emoji,
              }}
              jogadorB={{
                participantId: frenteFrente.b.participantId,
                nome: frenteFrente.b.nome,
                avatar: frenteFrente.b.avatar,
                emoji: frenteFrente.b.emoji,
              }}
